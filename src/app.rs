        ...
        if let Some(key) = event.as_key_press_event() {
            ...
            if key.kind == KeyEventKind::Press {
                match key.code {
                    ...
                    KeyCode::Tab => match self.navigation.view {
                        View::Lists => self.navigation.next_view(),
                        View::Items => self.next_command(),
                    },
                    KeyCode::BackTab => match self.navigation.view {
                        View::Lists => self.navigation.prev_view(),
                        View::Items => self.prev_command(),
                    },
